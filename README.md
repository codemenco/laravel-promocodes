...
[![laravel-promocodes](https://banners.beyondco.de/laravel-promocodes.jpeg?theme=light&packageManager=composer+require&packageName=codemenco%2Flaravel-promocodes&pattern=topography&style=style_2&description=Coupons+and+promotional+codes+generator.&md=1&showWatermark=0&fontSize=100px&images=https%3A%2F%2Flaravel.com%2Fimg%2Flogomark.min.svg)](https://github.com/codemenco/laravel-promocodes)

# laravel-promocodes

[![Packagist](https://img.shields.io/packagist/v/codemenco/promocodes.svg)](https://packagist.org/packages/codemenco/promocodes)
[![Packagist](https://img.shields.io/packagist/dt/codemenco/promocodes.svg)](https://packagist.org/packages/codemenco/promocodes)
[![license](https://img.shields.io/github/license/codemenco/promocodes.svg)](https://packagist.org/packages/codemenco/promocodes)
...
```bash
composer require codemenco/laravel-promocodes
```
...
Please see [CONTRIBUTING](https://github.com/codemenco/laravel-promocodes/blob/master/CONTRIBUTING.md) for details.

## Credits

- [Codemenco](https://github.com/codemenco)
- [All Contributors](https://github.com/codemenco/laravel-promocodes/graphs/contributors)

## License

The MIT License (MIT). Please see [License File](https://github.com/codemenco/laravel-promocodes/blob/master/LICENSE.md)
